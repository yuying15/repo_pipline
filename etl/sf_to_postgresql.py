...
def sf_to_postgresql():
    ...
    franchise_df = franchise_df \
        ...
        .withColumnRenamed("phone_number", "franchise_phone_number")  # Rename PHONE_NUMBER in franchise table
    ...
    customer_loyalty_df = customer_loyalty_df \
        ...
        .withColumnRenamed("phone_number", "customer_phone_number")  # Rename PHONE_NUMBER in customer_loyalty table
    ...
    # Save the joined DataFrame to PostgreSQL
    save_to_postgresql(joined_df, "joined_data")
